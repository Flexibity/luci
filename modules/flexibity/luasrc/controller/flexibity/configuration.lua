...
function index()
	...
	entry({"flexibity", "configuration"}, alias("flexibity", "configuration", "index"), i18n("Configuration"), 90).index = true
        ...
        entry({"flexibity", "configuration", "passwd"}, form("flexibity/passwd"), i18n("Password"), 2)
	...
	entry({"flexibity", "configuration", "upgrade"}, call("action_upgrade"), i18n("Upgrade"), 7)

	entry({"flexibity", "configuration", "reboot"}, call("action_reboot"), i18n("Reboot"), 100)
end
